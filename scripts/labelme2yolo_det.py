...
NAMES = ["1_5_centrifuge_tube","50_centrifuge_tube","1000_tip"]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--labelme_dir',type=str, default = '/Users/qingyuan/cv/qykw/zhili/test',
                        help='Please input the path of the labelme dataset.')
    parser.add_argument('--save_dir',type=str, default='/Users/qingyuan/cv/qykw/zhili/图片_yolo_add_3',
